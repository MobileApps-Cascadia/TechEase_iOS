...
struct EmergencyTutorialPart3: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "EmergencyInformationTutorialPart3", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("EmergencyInformationTutorialPart3Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                            ...
                            // Arica: A tutorial screenshot.
                            Image("EmergencyInformationTutorialPart3Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
                        ...
                        Group {
                            ...
                            // Arica: A tutorial screenshot.
                            Image("EmergencyInformationTutorialPart3Screenshot3")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarTitle("Emergency Part 3", displayMode: .inline)
        .navigationBarItems(trailing: Button(action: {
            self.appState.moveToDashboard = true
        }) {
            
            Text_to_SpeechButton(speech: "This is Part 3 of the Emergency Information Tutorial.")
...
struct EmergencyTutorialPart3_Previews: PreviewProvider {
    static var previews: some View {
        EmergencyTutorialPart3()
    }
}
