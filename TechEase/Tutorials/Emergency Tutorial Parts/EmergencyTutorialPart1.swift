...
struct EmergencyTutorialPart1: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "EmergencyInformationTutorialPart1", ofType: "txt") {
            do {
    ...
    var body: some View {
        ...
        .navigationBarTitle("Emergency Part 1", displayMode: .inline)
        .navigationBarItems(trailing: Button(action: {
            self.appState.moveToDashboard = true
        }) {
            
            Text_to_SpeechButton(speech: "This is Part 1 of the Emergency Information Tutorial.")
...
struct EmergencyTutorialPart1_Previews: PreviewProvider {
    static var previews: some View {
        EmergencyTutorialPart1()
    }
}
