...
struct EmergencyTutorialPart4: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "EmergencyInformationTutorialPart4", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("EmergencyInformationTutorialPart4Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                            ...
                            // Arica: A tutorial screenshot.
                            Image("EmergencyInformationTutorialPart4Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarItems(trailing: Button(action: {
            ...
            Text_to_SpeechButton(speech: "This is Part 4 of the Emergency Information Tutorial.")
...
struct EmergencyTutorialPart4_Previews: PreviewProvider {
    static var previews: some View {
        EmergencyTutorialPart4()
    }
}
