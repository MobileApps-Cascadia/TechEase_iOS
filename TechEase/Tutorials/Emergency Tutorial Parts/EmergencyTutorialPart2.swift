...
struct EmergencyTutorialPart2: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "EmergencyInformationTutorialPart2", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("EmergencyInformationTutorialPart2Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                        ...
                        Group {
                            ...
                            // Arica: A tutorial screenshot.
                            Image("EmergencyInformationTutorialPart2Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
                            ...
                            // Arica: A tutorial screenshot.
                            Image("EmergencyInformationTutorialPart2Screenshot3")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarTitle("Emergency Part 2", displayMode: .inline)
        .navigationBarItems(trailing: Button(action: {
            self.appState.moveToDashboard = true
        }) {
            
            Text_to_SpeechButton(speech: "This is Part 2 of the Emergency Information Tutorial.")
...
struct EmergencyTutorialPart2_Previews: PreviewProvider {
    static var previews: some View {
        EmergencyTutorialPart2()
    }
}
