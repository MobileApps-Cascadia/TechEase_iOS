...
struct CalendarTutorialPart3: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "CalendarTutorialPart3", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("CalendarTutorialPart3Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                            ...
                            // Arica: A tutorial screenshot.
                            Image("CalendarTutorialPart3Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarTitle("Calendar Part 3", displayMode: .inline)
        .navigationBarItems(trailing: Button(action: {
            self.appState.moveToDashboard = true
        }) {
            
            Text_to_SpeechButton(speech: "This is Part 3 of the Calendar Tutorial.")
...
struct CalendarTutorialPart3_Previews: PreviewProvider {
    static var previews: some View {
        CalendarTutorialPart3()
    }
}
