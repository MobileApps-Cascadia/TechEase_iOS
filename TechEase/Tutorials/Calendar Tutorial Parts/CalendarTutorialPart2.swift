...
struct CalendarTutorialPart2: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "CalendarTutorialPart2", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("CalendarTutorialPart2Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                            ...
                            // Arica: A tutorial screenshot.
                            Image("CalendarTutorialPart2Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
                        ...
                        Group {
                            ...
                            // Arica: A tutorial screenshot.
                            Image("CalendarTutorialPart2Screenshot3")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarTitle("Calendar Part 2", displayMode: .inline)
        .navigationBarItems(trailing: Button(action: {
            self.appState.moveToDashboard = true
        }) {
            
            Text_to_SpeechButton(speech: "This is Part 2 of the Calendar Tutorial.")
...
struct CalendarTutorialPart2_Previews: PreviewProvider {
    static var previews: some View {
        CalendarTutorialPart2()
    }
}
