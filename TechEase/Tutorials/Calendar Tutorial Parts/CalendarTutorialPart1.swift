...
struct CalendarTutorialPart1: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "CalendarTutorialPart1", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("CalendarTutorialPart1Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                        ...
                        Group {
                            ...
                            // Arica: A tutorial screenshot.
                            Image("CalendarTutorialPart1Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarItems(trailing: Button(action: {
            ...
            Text_to_SpeechButton(speech: "This is Part 1 of the Calendar Tutorial.")
...
struct CalendarTutorialPart1_Previews: PreviewProvider {
    static var previews: some View {
        CalendarTutorialPart1()
    }
}
