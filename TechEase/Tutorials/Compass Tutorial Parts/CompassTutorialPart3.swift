...
struct CompassTutorialPart3: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "CompassTutorialPart3", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("CompassTutorialPart3Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                            ...
                            // Arica: A tutorial screenshot.
                            Image("CompassTutorialPart3Screenshot2")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
                                .border(Color("DarkBlue"), width: 5)
        ...
        .navigationBarTitle("Compass Part 3", displayMode: .inline)
        .navigationBarItems(trailing: Button(action: {
            self.appState.moveToDashboard = true
        }) {
            
            Text_to_SpeechButton(speech: "This is Part 3 of the Compass Tutorial.")
...
struct CompassTutorialPart3_Previews: PreviewProvider {
    static var previews: some View {
        CompassTutorialPart3()
    }
}
