...
struct CompassTutorialPart2: View {
    ...
    func FileIO() -> [String] {
        ...
        if let filepath = Bundle.main.path(forResource: "CompassTutorialPart2", ofType: "txt") {
            do {
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            Image("CompassTutorialPart2Screenshot1")
                                .resizable()
                                .aspectRatio(contentMode: .fit)
                                .frame(width: 250.0)
        ...
        .navigationBarItems(trailing: Button(action: {
            ...
            Text_to_SpeechButton(speech: "This is Part 2 of the Compass Tutorial.")
...
struct CompassTutorialPart2_Previews: PreviewProvider {
    static var previews: some View {
        CompassTutorialPart2()
    }
}
